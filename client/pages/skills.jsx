...
function alertClicked() {
  this.alert('WARNING: Navigating outside of site!');
}
  ...
  render() {
    return (
      <div>
        ...
        <ReactBS.ListGroup>
          <ReactBS.ListGroupItem onClick={alertClicked}
            href="https://react-bootstrap.github.io/components.html#listgroup">
            React</ReactBS.ListGroupItem>
          <ReactBS.ListGroupItem onClick={alertClicked} href="https://lodash.com/">
            lodash</ReactBS.ListGroupItem>
          <ReactBS.ListGroupItem onClick={alertClicked} href="https://www.heroku.com/">
